declare const ENV: { FREQUENCY_LIST: { [key: string]: string } };

export const FREQUENCY_LIST = ENV.FREQUENCY_LIST;
export const ADJACENCY_GRAPHS: {
  qwerty: { [key: string]: string[] },
  dvorak: { [key: string]: string[] },
  keypad: { [key: string]: string[] },
  mac_keypad: { [key: string]: string[] }
} = {
    qwerty: {
      "!": ["`~", null, null, "2@", "qQ", null],
      "\"": [";:", "[{", "]}", null, null, "/?"],
